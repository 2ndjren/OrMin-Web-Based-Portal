...
<div class="h-screen w-full overflow-y-auto ">
  ...
  <div class="m-4 bg-gray-200 p-8 rounded-lg shadow-md overflow-hidden">
    <h2 class="text-lg text-gray-500 my-2">PRC ORMIN | Announcement | {{ $announcement->id }}</h2>
    ...
    <div class="p-6">
      ...
      <p class="text-lg text-gray-700 leading-relaxed" style="text-align: justify;">{{ $announcement->announcement }}</p>
