...
<div class="h-screen w-full overflow-y-auto ">
            ...
            <div class="lg:w-2/3  p-8 ">
              ...
              <div class="py-4">
                <div class="block text-center xl:text-left space-y-2 ">
                  <p class="text-gray-800 font-bold text-2xl xl:text-4xl text-shadow-sm">ORIENTAL MINDORO</p>
                  <p class="text-blue-800 font-bold text-4xl xl:text-6xl text-shadow-sm transition-transform ease-in-out transform hover:scale-110"><span class="text-red-700">RED CROSS 143 -</span> VOLUNTEER</p>
                  <p class="text-gray-800 text-2xl xl:text-5xl font-bold ">Local Chapter</p>
  ...
  <div class="bg-gray-200 p-4 md:p-28 flex flex-col-reverse md:flex-row w-full">
      ...
      <div class="w-full md:w-2/3 space-y-4 md:space-y-6 px-4 md:px-10">
        <h1 class="text-4xl md:text-4xl xl:text-6xl font-bold mb-2 md:mb-4 text-red-800  justify-center text-center md:text-right" data-aos="fade-up">
        Be a Red Cross Member
        </h1>
        <div class="text-red-500 text-center md:text-right md:text-xl">
