...
<div class="h-screen w-full overflow-y-auto ">
  ...
  <section class="bg-cover bg-no-repeat h-screen py-6 md:py-12" style="background-image: url('static/user/home/BLOOD.jpg'); display: flex; align-items: center; justify-content: center; text-align: center;">
    <div class="h-screen p-4 md:p-28 flex flex-col-reverse md:flex-row w-full">
        ...
        <div class="w-full md:w-2/3 space-y-4 md:space-y-6 px-4 md:px-10">
            <h1 class="text-4xl md:text-4xl xl:text-6xl font-bold mb-2 md:mb-4 text-white" data-aos="fade-up">
