            ...
            <div class="lg:w-2/3  p-8 ">
              ...
              <div class="py-4">
                <div class="block text-center xl:text-left space-y-2 ">
                  <p class="font-bold text-2xl text-red-700 xl:text-4xl text-shadow-sm">RED CROSS 143</p>
                  <p class="text-blue-800 font-bold text-3xl xl:text-5xl text-shadow-sm transition-transform ease-in-out transform hover:scale-110"><span class="text-blue-900">VOLUNTEER</span>ORIENTAL MINDORO</p>
