            ...
            <div class="lg:w-2/3  p-8 ">
              ...
              <div class="py-4">
                <div class="block text-center xl:text-left space-y-2 ">
                  ...
                  <p class="text-blue-800 font-bold text-3xl xl:text-5xl text-shadow-sm transition-transform ease-in-out transform hover:scale-110">ORIENTAL MINDORO CHAPTER</p>
