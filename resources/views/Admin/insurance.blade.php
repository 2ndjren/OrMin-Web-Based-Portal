...
<div id="membership-accounts-table" class="block w-full">
    ...
    <div class="">
      ...
      <div class="flex space-x-2">
        <div class="">
        <p>Classic</p> <p class="p-2 bg-blue-500"></p>
        </div>
        <div class="">
        <p>Bronze</p> <p class="p-2 bg-yellow-900"></p>
        </div>
        <div class="">
        <p>Silver</p> <p class="p-2 bg-gray-500"></p>
        </div>
        <div class="">
        <p>Gold</p> <p class="p-2 bg-yellow-500"></p>
        </div>
        <div class="">
        <p>Platinum</p> <p class="p-2 bg-red-500"></p>
        </div>
        <div class="">
        <p>Senior</p> <p class="p-2 bg-green-500"></p>
        </div>
        <div class="">
        <p>Senior Plus</p> <p class="p-2 bg-purple-600"></p>
        </div>
      </div>
      </div>
@if(session('ADMIN'))
...
<div id="create-membership-account-modal" class="fixed hidden px-4 inset-0 flex items-center justify-center z-20 bg-black bg-opacity-80">
  ...
  <h2 class="text-2xl font-semibold text-green-600">Create Membershipa</h2>
  ...
  <form id="create-membership-account"  enctype="multipart/form-data">
    ...
    <div class="mt-6 flex justify-end">
                ...
                <button type="submit" class="bg-blue-500 flex space-x-2 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg"><div>Save </div><div id="spinner" class=" hidden  border-b-2 w-5 h-5 border-white rounded-full animate-spin"></div></button>
            </div>
            </form>
  ...
  <div class="modal-container bg-white sm:w-full  lg:w-1/4 mx-auto rounded-lg p-4 shadow-lg ">
    ...
    <div id="annual_sales_report" class="hidden"> 
      ...
      <div class="mb-4 w-full " >
                ...
                <button type="submit" class="bg-blue-500 flex space-x-2 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg"><div>Proceed </div><div id="spinner" class=" hidden  border-b-2 w-5 h-5 border-white rounded-full animate-spin"></div></button>
            </div>
      </form>
    </div>
