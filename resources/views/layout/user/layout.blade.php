          ...
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
              <ul class="flex flex-col font-lg font-bold p-4 md:p-0 mt-4  md:flex-row md:space-x-14 md:mt-0">
                ...
                <li>
                  <a href="#" class="flex items-center justify-between w-full py-2 pl-3 pr-4  text-white hover:bg-white hover:text-red-700">About</a>
                </li>
                <li>
                  <a href="#" class="flex items-center justify-between w-full py-2 pl-3 pr-4  text-white hover:bg-white hover:text-red-700">Contact</a>
                </li>
